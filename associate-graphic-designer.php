...
<div class="custom_container">
  <div class="bread-crumb">
    <ul class="clearfix">
      ...
      <li><a href="associate-graphic-designer.php?job_id=<?php echo $id;?>" class="active"><?php echo $res['job_title'];?></a></li>
    </ul><!--clearfix-->
  </div><!--bread-crumb-->
  ...
  <div class="position-data">
    ...
    <ul class="job-description-details">
     ...
     <p class="apply-btn"><a href="associate-graphic-designer-application.php?job_id=<?php echo $id;?>" class="apply-form">Apply For this Job</a></p>
  </div><!--position-data-->
