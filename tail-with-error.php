...
<link rel="stylesheet" href="css/christmas-santa-script.css">
...
<script src="js/christmas-santa-script.js"></script>
...
lightGallery(document.getElementById('static-thumbnails-lightgallery'), {
    animateThumb: false,
...
<!-- <script>
   $(".karya a").slice(10).hide();
 var mincount = 10;
 var maxcount = 20;
 $(window).scroll(function () {
     if ($(window).scrollTop() + $(window).height() >= $(document).height() - 50) {
         $(".karya a").slice(mincount, maxcount).slideDown(1400);
