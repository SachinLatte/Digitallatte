...
<script type="application/ld+json">
{
  ...
  "itemListElement": [{
    ...
    "item": "https://www.digitallatte.in/our-expertise/digital-marketing-services/Digital-Strategy-Consulting"
  }]
}
</script>
...
<section class="home_banner service-original-bg">
  <div class="home_banner_content mrgn">
    <h1><img src="<?php echo base_url; ?>img/digital-stratrgy.png"> <p><strong>Digital Strategy</strong> <br/>Consulting</p></h1>
  </div>
  ...
  <div class="service-bio custom_container">
    <div class="bread-crumb">
      <ul class="clearfix">
        ...
        <li><a href="#" class="active">Digital Strategy Consulting</a></li>
      </ul><!--clearfix-->
    </div><!--bread-crumb-->

    <h1 class="service-main-head">If you bring a knife to a gunfight,  <br/> it's going to end badly for you. </h1>
    <div class="service-bio-copy">
      <p>Have an in-house Digital Team? Unable to get the best out of your Digital Agency? Finding it
        difficult to align your Corporate strategy with your Digital Strategy?</p>
      <p>In the past, Marketing was simple with a limited set of activities. But it's a different ball
         game today. Competition is rife, advertising costs are high, new social media platforms are blooming
          every year & customers are dispersed, distracted and skeptical. </p>
      <p>Digital technologies have changed the world as well as the way marketing and business is done today.
        To keep pace with the changing trends, Digital Strategy Consulting has become essential for all organisations, big & small.</p>
      <p>Get in touch with us and bring in Digital Experts to redefine and transform your Digital Media Marketing approach.</p>
