...
</style><!--[if IE 6]> <link rel="stylesheet" href="<?php bloginfo('template_directory');?>/ie6.css" /><![endif]-->
</head>
<body>
<div id="PageHolder">
	...
	<div id="top">
		...
		<div id="orange">
			<ul id="nav">
				<li>
					<a href="<?php bloginfo("url");?>" class="menu <?php if(is_home()):?>active<?php endif;?>">Home</a></li>
