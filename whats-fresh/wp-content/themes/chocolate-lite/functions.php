...
?>
<div class="lcomment_box mbottom14 flt" id="li-comment-<?php comment_ID(); ?>">
	<div id="comment-<?php comment_ID(); ?>">
			<div class="user_pic mright10 flt">
				<?php echo get_avatar($comment,$size='45',$default='' ); ?>
			</div>
			<div class="user_com flt">
				<?php comment_text(); ?>
				<span><cite class="fn"><?php comment_author_link(); ?></cite></span>
			</div>
